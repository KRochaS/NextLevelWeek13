            ...
            <main className="flex-1 p-6 flex gap-6">
                <div className="flex flex-col flex-1 gap-4">
                    <div className="grid grid-row-2 gap-4 flex-1">
                        <Textarea placeholder="Inclua o rompt para a IA..." className="resize-none p-5 leading-relaxed" />
                        <Textarea placeholder="Resultado erado pela IA" readOnly className="resize-none p-5 leading-relaxed" />
                    </div>
